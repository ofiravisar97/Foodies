    ...
    return (
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Landing">
          ...
          <Stack.Screen name="Register" component={RegisterScreen} options={{ headerTintColor: COLORS.primary, headerTitleStyle: { fontWeight: 'bold' } }} />
        </Stack.Navigator>
      </NavigationContainer>
    );
  } else { // Logged In
      ...
      <Provider store={store}>
        <NavigationContainer>
          ...
          >
            ...
            <Stack.Screen name="Save" component={SaveScreen} options={{
              title: "Add Recipe",
            }} />
          </Stack.Navigator>
        </NavigationContainer>
